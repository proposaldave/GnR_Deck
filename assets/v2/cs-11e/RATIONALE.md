...
Strategic role: traction. Claim: Same courts. Better groups. More revenue.. Audience emotion: clarity and momentum. Recommended variant: v1-hero when an editorial image exists for this slide; otherwise v2-type because the headline carries more investor force than decorative diagrams.
