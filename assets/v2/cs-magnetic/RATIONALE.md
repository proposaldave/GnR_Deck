# cs-magnetic Rationale

Strategic role: mechanism. Claim: Skill ratings miss the social pull.. Audience emotion: clarity and momentum. Recommended variant: v1-hero when an editorial image exists for this slide; otherwise v2-type because the headline carries more investor force than decorative diagrams.
